...
import {Block, CodeGenerator, Names, type Workspace } from 'blockly/core';
import * as Blockly from 'blockly/core';

const inputTypes = Blockly.inputs.inputTypes;
const wrap = Blockly.utils.string.wrap
...
export class LuaGenerator extends CodeGenerator {
  constructor(name = 'Lua') {
    ...
    this.addReservedWords(
      // Special character
      '_,' +
        'assert,bit32,buffer,collectgarbage,coroutine,error,_G' +
        'getmetatable,ipairs,loadstring,' +
        'next,math,os,pairs,pcall,print,' +
        'rawequal,rawget,rawlen,rawset,require,select,' +
        'setfenv,setmetatable,string,table,tonumber,' +
        'tostring,type,typeof,unpack,vector,xpcall,_VERSION,' +
        ...
        '__add,__sub,__mul,__div,__idiv,__mod,__pow,__unm,__concat,__len,__eq,__lt,__le,__index,__newindex,__call,__namecall'
    );
  }
