...
export function generateBlogOGImage(
  ...
  const { title, description, tags, slug, authorName, authorAvatar, primaryTextColor, showLogo = true, showAuthor = true, ...rest } = options;
...
export function generateBlog({
  ...
  const title = typeof props.title === 'string' && props.title.length > 50 
    ? props.title.substring(0, 50) + '...' 
    : props.title;
  
  // Truncate description if too long
  const description = typeof props.description === 'string' && props.description && props.description.length > 100 
