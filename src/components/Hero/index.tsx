		...
		<>
			<section className="relative overflow-hidden bg-gradient-to-b from-background to-background/95 pt-10 pb-0">
				...
				<div className="absolute inset-0 overflow-hidden">
					<div className="absolute top-0 left-1/4 w-[500px] h-[500px] rounded-full bg-primary/5 blur-[120px] animate-pulse" style={{ animationDuration: '8s' }}></div>
					<div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] rounded-full bg-accent/5 blur-[100px] animate-pulse" style={{ animationDuration: '10s' }}></div>
					<div className="absolute top-1/3 right-1/3 w-[300px] h-[300px] rounded-full bg-primary/10 blur-[80px] animate-pulse" style={{ animationDuration: '12s' }}></div>
				...
				<main className="container mx-auto px-4 py-16 relative z-10" ref={heroRef}>
					...
					>
						...
						>
							...
							<span className="text-primary/90 font-monster text-sm font-medium tracking-wider uppercase">Most Advanced Security</span>
						...
						>
							<div className="inline-flex items-center gap-4 px-6 py-2 rounded-full bg-accent/10 backdrop-blur-sm border border-accent/20 mb-8 shadow-lg shadow-accent/5">
								<span className="h-px w-5 bg-gradient-to-r from-transparent to-primary"></span>
								<span className="text-primary font-monster text-sm font-medium tracking-wider uppercase">Trusted by top servers</span>
								<span className="h-px w-5 bg-gradient-to-r from-primary to-transparent"></span>
							</div>
				...
				<div className="relative h-24 mt-10">
					<svg className="absolute bottom-0 w-full h-24 fill-background" viewBox="0 0 1440 74" preserveAspectRatio="none">
