...
const Status: React.FC = () => {
  ...
  const summaryMetrics = useMemo(() => {
    ...
    const avgLatency = Math.round(
      Object.values(data.shard_conns).reduce((sum, shard) => sum + shard.real_latency, 0) / totalShards,
    )
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="bg-card p-8 rounded-xl border border-destructive/50 max-w-md">
          ...
          <p className="text-muted-foreground mb-4">We encountered an error while fetching the bot status data:</p>
          <div className="bg-secondary/50 p-4 rounded-lg font-mono text-sm overflow-auto">{error.message}</div>
          <button
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="bg-card p-8 rounded-xl border border-border max-w-md">
          ...
          <p className="text-muted-foreground mb-4">We couldn't retrieve any status data for the bot at this time.</p>
          <button
            onClick={() => window.location.reload()}
      ...
      >
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Real-time monitoring dashboard for all bot shards and services</p>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="ml-auto flex items-center gap-2">
              <div
                ...
                style={{
                  backgroundColor: summaryMetrics!.healthPercentage > 90 ? "hsl(142, 76%, 36%)" : "hsl(38, 92%, 50%)",
                }}
              ></div>
              <span className="text-sm font-medium">{summaryMetrics!.healthPercentage}% Healthy</span>
            </div>
          </div>
        </div>
      </motion.div>
                ...
                <div className="h-[400px]">
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      />
                      <Bar dataKey="latency" fill="hsl(var(--primary))" radius={[4, 4, 0, 0]} barSize={30} />
                    </BarChart>
                  </ResponsiveContainer>
                </div>
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-card rounded-xl border border-border/50 p-6 shadow-lg">
                ...
                <div className="h-[400px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={chartData.latencyData} margin={{ top: 20, right: 30, left: 20, bottom: 60 }}>
                      <CartesianGrid strokeDasharray="3 3" stroke="hsl(var(--border))" opacity={0.3} />
                      <XAxis
                        dataKey="name"
                        angle={-45}
              ...
              <div className="bg-card rounded-xl border border-border/50 p-6 shadow-lg">
                ...
                <div className="h-[400px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={chartData.guildData} margin={{ top: 20, right: 30, left: 20, bottom: 60 }}>
                      <CartesianGrid strokeDasharray="3 3" stroke="hsl(var(--border))" opacity={0.3} />
                      <XAxis
                        dataKey="name"
                        angle={-45}
                      ...
                      />
                      <Bar dataKey="guilds" fill="hsl(var(--extra))" radius={[4, 4, 0, 0]} barSize={30} />
                    </BarChart>
                  </ResponsiveContainer>
                </div>
              </div>
                ...
                <div className="h-[400px]">
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      />
                      <Bar dataKey="uptime" fill="hsl(142, 76%, 36%)" radius={[0, 4, 4, 0]} barSize={15} />
                    </BarChart>
                  </ResponsiveContainer>
                </div>
              </div>
