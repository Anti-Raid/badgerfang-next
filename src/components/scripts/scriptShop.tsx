    ...
    <div className="relative overflow-hidden bg-gradient-to-b from-background to-background/95 py-16">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="mb-20 text-center" ref={headerRef}>
          ...
          >
            Discover premium, ready-to-use scripts built by the AntiRaid community to enhance your Discord server
            experience. Browse, preview, and install with just a few clicks.
          </motion.p>
        </div>
        ...
        >
          <div className={`relative transition-all duration-300 ${isSearchFocused ? "scale-105" : "scale-100"}`}>
            ...
            <div className="relative bg-card/80 backdrop-blur-md border border-border hover:border-primary/30 rounded-2xl shadow-xl transition-all duration-300 flex items-center overflow-hidden">
              ...
              {searchTerm && (
                <button onClick={clearSearch} className="mr-2 p-2 hover:bg-primary/10 rounded-full transition-colors">
        ...
        <AnimatePresence mode="wait">
          {filteredData.length === 0 ? (
            ...
            <motion.div
              ...
              exit={{ opacity: 0 }}
              className={
                viewMode === "grid" ? "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" : "flex flex-col space-y-6"
              }
            >
