    ...
    <div className="space-y-6">
      <div className="bg-card border border-border rounded-lg p-5 shadow-sm">
        ...
        <div className="space-y-4">
          ...
          <Primary Title={isLoading ? "Creating..." : "Create Lockdown"} onClick={handleAddLockdown} icon={FaLock} />
        </div>
      </div>
      ...
      <div className="mt-8">
        ...
        {isLoading ? (
          ...
          <div className="bg-muted/30 rounded-lg p-8 text-center">
            ...
            <p className="text-muted-foreground text-sm">Your server is currently operating normally</p>
          </div>
        ) : (
                  ...
                  <div className="flex flex-col md:flex-row md:items-center gap-3">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        <span className={`px-2 py-1 rounded-md text-xs font-medium ${getTypeColor(lockdown.type)}`}>
