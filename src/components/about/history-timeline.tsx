  ...
  return (
    ...
    >
      <div className={`flex items-center ${isEven ? "flex-row" : "flex-row-reverse"}`}>
        {/* Text Content */}
        <div className={`w-full md:w-5/12 ${isEven ? "text-right pr-4 md:pr-8" : "text-left pl-4 md:pl-8"}`}>
          ...
          <h3 className="text-xl md:text-2xl font-monster font-bold mb-2 relative inline-block">
            {event.title}
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2 z-10">
          <div className="w-14 h-14 rounded-none bg-background border-2 border-primary flex items-center justify-center relative group">
