...
const Button: React.FC<React.ButtonHTMLAttributes<HTMLButtonElement> & {
  ...
  const baseStyles = "px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary/50";
              ...
              <div className="space-y-1">
                ...
                <div className="flex flex-wrap gap-1">
                  ...
                  {!expanded && command.subcommands.length > 3 && (
                    <Badge className="bg-secondary/50 text-secondary-foreground cursor-pointer" onClick={() => setExpanded(true)}>
              ...
              <div className="space-y-1">
                ...
                <div className="flex flex-wrap gap-1">
                  {botState.command_permissions[command.qualified_name || command.name]
                    .slice(0, expanded ? botState.command_permissions[command.qualified_name || command.name].length : 2)
                    .map((perm, idx) => (
                      <Badge
                        key={idx}
                  ...
                  {!expanded && botState.command_permissions[command.qualified_name || command.name].length > 2 && (
                    <Badge className="bg-accent/50 text-accent-foreground cursor-pointer" onClick={() => setExpanded(true)}>
                          ...
                          <div className="mt-1">
                            ...
                            <div className="flex flex-wrap gap-1 mt-1">
                              {arg.choices.map((choice, idx) => (
                                <Badge key={idx} className="bg-secondary/70 text-secondary-foreground">
                                  {choice}
                                </Badge>
                              ))}
                            </div>
