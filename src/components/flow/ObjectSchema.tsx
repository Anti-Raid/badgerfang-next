...
export class SchemaBuilder {
	...
	addTaggedUnion(
		...
		return this.addProperty(
			name,
			SchemaBuilder.taggedUnionCol(tag_col, schemas, desc, required, bare)
		);
	}
...
export const discordApiSchemas = {
	create_interaction_response: new SchemaBuilder(
		...
		.addObjectSchema(
			'data',
			new SchemaBuilder('Interaction Response Data', 'The data for the interaction response')
				.addTaggedUnion(
					'type',
					...
					new SchemaTaggedUnionBuilder()
						.addSchema(
							1,
							'Pong',
							new SchemaBuilder('Pong Response', 'A simple pong response').build()
						)
						.addSchema(
							4,
							'Channel Message with Source',
							new SchemaBuilder('Channel Message with Source', 'A message to send in a channel')
								.addObjectSchema(
									'data',
