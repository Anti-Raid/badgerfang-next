import { ConditionalLogicTypeEnum, conditionalLogicTypeEnumToString, ConditionalType, ConditionalTypeContinuable, ConditionalTypeEnum, ConditionalTypeLogic, ConditionalTypeParensBlock, stringToConditionalLogicTypeEnum, TypedInputEnum } from "@/lib/flow/data"
 ...
 */
export const ConditionalTypeContinuationField: React.FC<ConditionalTypeContinuationProps> = ({ value, onChange }) => {
    return (
        <>
            {value ? (
        ...
        <>
            ...
            <div className="flex items-center gap-2">
                <InputField 
                    ...
                    options={[
                        { label: "Unselected", value: stringToConditionalLogicTypeEnum(ConditionalLogicTypeEnum.Unselected) },
                        { label: "Equals", value: stringToConditionalLogicTypeEnum(ConditionalLogicTypeEnum.IfEq) },
                        { label: "Not Equals", value: stringToConditionalLogicTypeEnum(ConditionalLogicTypeEnum.IfNeq) },
                        { label: "Greater Than", value: stringToConditionalLogicTypeEnum(ConditionalLogicTypeEnum.IfGt) },
                        { label: "Less Than", value: stringToConditionalLogicTypeEnum(ConditionalLogicTypeEnum.IfLt) },
                        { label: "Greater Than or Equal To", value: stringToConditionalLogicTypeEnum(ConditionalLogicTypeEnum.IfGte) },
                        { label: "Less Than or Equal To", value: stringToConditionalLogicTypeEnum(ConditionalLogicTypeEnum.IfLte )},
                    ]}
                    onChange={(e) => {
                        onChange({
                            ...value,
...
const ConditionalTypeParensBlockField: React.FC<ConditionalTypeParensBlockProps> = ({ value, onChange }) => {
    return (
        <div className="gap-2 p-9">
