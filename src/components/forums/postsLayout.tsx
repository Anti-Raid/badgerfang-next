...
import { ArrowUp, ArrowDown, MessageCircle, Share2, Clock, Send, X, ExternalLink } from 'lucide-react';
    ...
    <div className="mx-auto max-w-3xl">
      ...
      >
        ...
        <div className="p-4">
          ...
          {post.image && (
            <div
              className="relative mb-6 overflow-hidden rounded-md cursor-pointer"
              onClick={() => {
          ...
          {post.plugins?.map((item, idx) => {
            if (item.type === 'tenor') {
              return (
                <div key={`tenor-${idx}`} className="relative mb-6 overflow-hidden rounded-md cursor-pointer" onClick={() => openImageModal(item.href as string)}>
                  <Image
            ...
            if (item.type === 'url' && item.jsonData) {
              return (
                <div
                  key={`url-${idx}`}
                  className="mb-6 overflow-hidden rounded-md border border-border/30 bg-muted/10"
                >
                  ...
                  {item.jsonData.image && (
                    <div className="relative h-60 w-full overflow-hidden cursor-pointer" onClick={() => openImageModal(item.jsonData.image)}>
                      <Image
              ...
              >
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    {comment.image && (
                      <div className="mt-2 overflow-hidden rounded-md cursor-pointer" onClick={() => openImageModal(comment.image || '/logo.webp')}>
                        <Image
