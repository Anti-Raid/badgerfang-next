                ...
                <div className="space-y-6">
                  {user.bio && (
                    ...
                    >
                      ...
                      <p className="text-foreground rounded-md bg-muted/10 p-3 border border-border/20">{user.bio}</p>
                    </motion.div>
                  )}
                  ...
                  {user.discord_id && (
                    <motion.div
                      ...
                      transition={{ delay: 0.3 }}
                    >
                      <h4 className="mb-2 text-sm font-medium text-muted-foreground">Connected Accounts</h4>
                      <div className="flex items-center gap-2 rounded-md border border-border/30 bg-muted/10 p-3 transition-all duration-300 hover:bg-muted/20 hover:border-primary/30 group">
                        ...
                        <span className="text-sm group-hover:text-primary transition-colors duration-300">Discord</span>
                  ...
                  {user.staff_perms && user.staff_perms.length > 0 && (
                    ...
                    >
                      <h4 className="mb-2 text-sm font-medium text-muted-foreground">Staff Permissions</h4>
                      <div className="flex flex-wrap gap-2">
