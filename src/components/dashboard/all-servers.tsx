          ...
          {!showViewButton && !searchTerm && servers.length === 0 && (
            <div className="mt-4 p-4 bg-[#3c2854] rounded-lg max-w-md text-sm">
              <p className="text-gray-300 mb-2">
                <strong>Note:</strong> You need <span className="text-purple-300">Manage Server</span> or <span className="text-purple-300">Administrator</span> permissions to add bots to a server.
              </p>
